<?php namespace Wing\Wkhtmltopdf\Library;
/**
...
class Wkhtmltopdf
{
    ...
    protected $_minimum_font_size = 50; //官方默认为5 生成pdf后字体很小 可选值 50、60 推荐
    /**
     * Path to executable.
     */
    ...
    {
        $this->_minimum_font_size = $size;
    }

    public function getMinimumFontSize()
    {
        return $this->_minimum_font_size;// = $size;
    }
    //--minimum-font-size
    /**
    ...
    protected function _getCommand()
    {
        ...
        $command .= " --minimum-font-size ".$this->getMinimumFontSize();
